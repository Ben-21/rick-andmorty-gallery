...
export const characterList = initialCharacterList.map(value => ({id: value.id.toString(), name: value.name, status: value.status, species: value.species, gender: value.gender, image: value.image}))